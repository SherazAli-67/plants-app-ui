...
class AppData {
  ...
  static List<PlantItemModel> get plants => [
    PlantItemModel(id: '1', title: 'The Palm Bliss', description: 'Perfect for beginners or anyone looking for an easy-to-care-for plant', image: AppIcons.palmBlissPlant, price: 49.9, color: AppColors.plantItemColor1),
    PlantItemModel(id: '2', title: 'The Potted Head', description: 'A tall statement plant that thrives in bright indirect light', image: AppIcons.pottedHeadPlant, price: 74.9, color: AppColors.plantItemColor2),
